...
<form action="<?php echo JRoute::_('index.php?option=com_menus&view=adminitems');?>" method="post" name="adminForm" id="adminForm">
		...
		foreach ($this->items as $i => $item) :
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					...
					<?php endif; ?>
					<?php if ($canEdit) : ?>
						<a href="<?php echo JRoute::_('index.php?option=com_menus&task=adminitem.edit&id='.(int) $item->id);?>">
				...
				<td class="center">
					<?php if ($item->type == 'component') : ?>
						...
						<?php elseif ($canChange):?>
							<a href="<?php echo JRoute::_('index.php?option=com_menus&task=adminitems.unsetDefault&cid[]='.$item->id.'&'.JUtility::getToken().'=1');?>">
