 ...
 * @since		1.6
 */
class MenusControllerAdminitems extends JControllerAdmin
{
	 ...
	 * @since	1.6
	 */
	function getModel($name = 'Adminitem', $prefix = 'MenusModel', $config = array())
	{
	...
	public function rebuild()
	{
		...
		$this->setRedirect('index.php?option=com_menus&view=adminitems');
