...
if ($item->menu_image) {
		...
		$linktype = '<img src="'.$item->menu_image.'" alt="'.JText::_($item->title).'" /><span class="image-title">'.JText::_($item->title).'</span> ' :
		$linktype = '<img src="'.$item->menu_image.'" alt="'.JText::_($item->title).'" />';
}
else { $linktype = JText::_($item->title);
}
