 ...
 * @since    2.5
 */
abstract class JSquareoneLoader extends JLoader
{
	/**
	...
	{
		spl_autoload_register(array('JSquareoneLoader', '_autoload'));
	}
	...
	private static function _autoload($class)
	{
		...
		if (substr($class, 0, 2) == 'S1') {
			// Split the class name (without the S1) into parts separated by camelCase.
			...
			$path = JPATH_PLATFORM . '/squareone/' . implode('/', array_map('strtolower', $parts)) . '.php';
